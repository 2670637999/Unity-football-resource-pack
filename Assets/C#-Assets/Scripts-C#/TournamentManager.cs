...
public class TournamentManager : MonoBehaviour {
	...
	void setLevelASettings() {
		...
		btnStartText.GetComponent<TextMesh>().text = "开始";
	...
	void setLevelBSettings() {
		...
		if(PlayerPrefs.GetInt("TorunamentMatchResult") == 1) {
			btnStartText.GetComponent<TextMesh>().text = "继续";
			btnStart.GetComponent<BoxCollider>().enabled = true;
		} else {
			btnStartText.GetComponent<TextMesh>().text = "主菜单";
			btnStart.GetComponent<BoxCollider>().enabled = true;
	...
	void setLevelDSettings() {
		...
		if(PlayerPrefs.GetInt("TorunamentMatchResult") == 1) {
			...
			btnStartText.GetComponent<TextMesh>().text = "完成";
			btnStart.GetComponent<BoxCollider>().enabled = true;
			btnExit.SetActive(false);
			...
			btnStartText.GetComponent<TextMesh>().text = "哦，不！!";
			btnStart.GetComponent<BoxCollider>().enabled = true;
			btnExit.SetActive(false);
		}
	}
